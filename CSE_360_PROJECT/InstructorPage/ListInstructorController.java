...
public class ListInstructorController {
    ...
    public void loadAllStudents() throws SQLException {
        ...
        ResultSet resultSet = dataBaseHelper.getStudentsByInstructor(username);// Method to fetch all classes
    ...
    public  void loadStudentsData(ResultSet resultSet) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            String enrolledClasses = resultSet.getString("className"); // Same for this column
